...
- Clone the forked repository to your local development machine
  (e.g. `git clone git@github.com:<YOUR_GITHUB_USER>/magic_draw.git`).
...
Go to the [pull request page of MagicDraw][PRs] and in the top
...
[GitHub issue]: https://github.com/signmotion/magic_draw/issues/new
[GitHub issues]: https://github.com/signmotion/magic_draw/issues/new
[PRs]: https://github.com/signmotion/magic_draw/pulls
